...
export const icons = [
  ...
  { name: 'shaving-brush', category: 'tools', keywords: ['badger', 'lather', 'shave', 'brush'],
    body: `<path d="M8.5 10.5C8.5 6 10 3 12 3s3.5 3 3.5 7.5Z"/><path d="M10.5 6.5v4M12 4.5v6M13.5 6.5v4"/><path d="M8 10.5h8v2H8Z"/><path d="M9.5 12.5v5.5a2.5 2.5 0 0 0 5 0v-5.5"/>` },
  ...
  { name: 'beard-trim', category: 'services', keywords: ['beard', 'trim', 'shape', 'facial hair'],
    body: `<path d="M4 6c0 8 3 13 8 13s8-5 8-13c-1.5 1-3 1.5-4 1.5-1.5 0-2.5-1-4-1s-2.5 1-4 1c-1 0-2.5-.5-4-1.5Z"/><path d="M9.5 12.5c1.5 1 3.5 1 5 0"/><path d="M10 10.5c1-.8 1.5-.3 2 0 .5-.3 1-.8 2 0"/>` },
  ...
  { name: 'mustache', category: 'services', keywords: ['moustache', 'handlebar', 'facial hair'],
    body: `<path d="M12 13C10 10.5 7.5 10 5.5 11c-1 .5-1.5 1.5-2.5 1.5 1.5 1.5 4 2.5 6.5 2 1.3-.3 2-.8 2.5-1.5ZM12 13c2-2.5 4.5-3 6.5-2 1 .5 1.5 1.5 2.5 1.5-1.5 1.5-4 2.5-6.5 2-1.3-.3-2-.8-2.5-1.5Z"/>` },
  { name: 'eyebrows', category: 'services', keywords: ['brows', 'threading', 'shaping', 'grooming'],
    body: `<path d="M3 9c2.5-2.5 6-2.5 8.5-.5M12.5 8.5c2.5-2 6-2 8.5.5"/><path d="M7 14h.01M17 14h.01"/>` },
  ...
  { name: 'barber', category: 'programs', keywords: ['stylist', 'professional', 'pro', 'person'],
    body: BUST + `<path d="M9.5 11c1-1 2-1 2.5 0 .5-1 1.5-1 2.5 0"/>` },
