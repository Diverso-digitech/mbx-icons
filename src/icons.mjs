...
//
// Every icon is drawn on a 24×24 grid as an outline: no fill, stroke 1.75,
...
export const icons = [
  ...
  { name: 'shaving-brush', category: 'tools', keywords: ['badger', 'lather', 'shave', 'brush'],
    body: `<path d="M7.5 11C7.5 6.5 9.5 3 12 3s4.5 3.5 4.5 8Z"/><path d="M10 7v4M12 5v6M14 7v4"/><path d="M7 11h10v2H7Z"/><path d="M9 13v5a3 3 0 0 0 6 0v-5"/>` },
  ...
  { name: 'wash-basin', category: 'tools', keywords: ['sink', 'shampoo bowl', 'backwash', 'wash'],
    body: `<path d="M3 12h18c0 4-3 7-9 7s-9-3-9-7Z"/><path d="M12 12V7a2 2 0 0 1 2-2h2v3"/><path d="M12 15h.01"/>` },
  ...
  { name: 'beard', category: 'services', keywords: ['beard trim', 'beard', 'shape', 'facial hair', 'beard & shave'],
    body: `<path d="M6 10a6 6 0 0 1 12 0"/><path d="M6 10v2c0 5 2.5 8 6 8s6-3 6-8v-2"/><path d="M9.5 8.5h.01M14.5 8.5h.01"/><path d="M10 12.5c1-1 1.5-.5 2 0 .5-.5 1-1 2 0"/><path d="M10.5 14.5c1 .8 2 .8 3 0"/><path d="M8.5 15l1 2M12 17v2.5M15.5 15l-1 2"/>` },
  ...
  { name: 'line-up', category: 'services', keywords: ['edge up', 'shape up', 'hairline', 'edges'],
    body: `<path d="M6 10c0-4 2.5-6.5 6-6.5S18 6 18 10"/><path d="M3 10h18"/><path d="M6 10v5a6 6 0 0 0 12 0v-5"/><path d="M9.5 14h.01M14.5 14h.01"/>` },
  ...
  { name: 'add-on', category: 'services', keywords: ['extra', 'upsell', 'tag', 'plus'],
    body: `<path d="M3 3h7l9 9-7 7-9-9Z"/><path d="M7 7h.01"/><path d="M18 15v6M15 18h6"/>` },

  { name: 'hair', category: 'services', keywords: ['hair category', 'head', 'quiff', 'root'],
    body: `<circle cx="12" cy="12.5" r="7.5"/><path d="M5.5 10.5c1-4 4-6.5 8-6 2.5.3 4.5 2 5.5 4-1.5-1-3-1.2-4.5-.5-2 1-4.5 1-6.5 0-1 .5-2 1.5-2.5 2.5Z" fill="currentColor"/>` },
  { name: 'hair-styling', category: 'services', keywords: ['styling', 'style', 'comb', 'pomade', 'blow out'],
    body: `<path d="M4 5.5A1.5 1.5 0 0 1 5.5 4h13A1.5 1.5 0 0 1 20 5.5V7H4Z"/><path d="M6 7v3M9 7v3M12 7v3M15 7v3M18 7v3"/><path d="M6 13h12v2H6Z"/><path d="M7 15h10v4.5a1.5 1.5 0 0 1-1.5 1.5h-7A1.5 1.5 0 0 1 7 19.5Z"/>` },
  ...
  { name: 'perm', category: 'services', keywords: ['perm', 'curls', 'curly', 'texture', 'wave'],
    body: `<path d="M6 9a2 2 0 1 1 3 1.7A2 2 0 1 1 12 9a2 2 0 1 1 3 1.7A2 2 0 1 1 18 9"/><path d="M6 9v3a6 6 0 0 0 12 0V9"/><path d="M9.5 12.5h.01M14.5 12.5h.01"/>` },
  ...
  { name: 'scalp-micropigmentation', category: 'services', keywords: ['smp', 'scalp', 'micropigmentation', 'hairline tattoo'],
    body: BUST + `<path d="M9.5 6.5h.01M12 5.5h.01M14.5 6.5h.01M10.5 8.5h.01M13.5 8.5h.01"/>` },
  { name: 'house-call', category: 'services', keywords: ['house call', 'mobile', 'home visit', 'on location'],
    body: `<path d="M3 11l9-8 9 8"/><path d="M5 10v11h14V10"/><path d="M10 13h4v7h-4Z"/><path d="M10 16l4-1.3M10 18.7l4-1.3"/>` },
  ...
  { name: 'pedicure', category: 'services', keywords: ['pedicure', 'foot', 'feet', 'toes'],
    body: `<path d="M12 22c-3 0-5-2.5-5-6.5 0-2.5 2-5.5 5-5.5s5 3 5 5.5c0 4-2 6.5-5 6.5Z"/><circle cx="7" cy="6.5" r="2"/><path d="M11 4.5h.01M14 4h.01M17 5h.01M19.5 7.5h.01"/>` },
  { name: 'acrylic-nails', category: 'services', keywords: ['acrylic', 'nail set', 'coffin', 'full set', 'mags'],
    body: `<path d="M9 3h6l-1 14a2 2 0 0 1-4 0Z"/><path d="M9.5 9a2.5 2.5 0 0 1 5 0"/><path d="M19 3v3M17.5 4.5h3"/>` },
  { name: 'gel-nails', category: 'services', keywords: ['gel', 'uv lamp', 'shellac', 'cure'],
    body: `<path d="M4 15v-4a8 8 0 0 1 16 0v4Z"/><path d="M3 15h18v3H3Z"/><path d="M12 15V9M9 15l-1.5-4.5M15 15l1.5-4.5"/>` },
  { name: 'skin-face', category: 'services', keywords: ['skin', 'face', 'skincare', 'glow'],
    body: `<path d="M11 3.5C7.5 4 5.5 7.5 5.5 11.5s2.5 8.5 6.5 8.5 6.5-4.5 6.5-8.5"/><path d="M9.5 11h.01M14.5 11h.01"/><path d="M10.5 15c.8.6 2.2.6 3 0"/><path d="M19 3v4M17 5h4"/>` },
  ...
  { name: 'waxing', category: 'services', keywords: ['face waxing', 'wax strip', 'hair removal', 'wax'],
    body: `<path d="M3.5 15l10-10 4.5 4.5-10 10Z"/><path d="M8 19.5c-1 1.2-2.6 1.6-4.5 1.5-.1-1.9.3-3.5 1.5-4.5"/><path d="M19 14c-1.3 1.6-1.6 2.3-1.6 3a1.6 1.6 0 0 0 3.2 0c0-.7-.4-1.4-1.6-3Z"/>` },
  { name: 'body-waxing', category: 'services', keywords: ['body waxing', 'leg', 'wax strip', 'hair removal'],
    body: `<path d="M5 12h14v6a3 3 0 0 1-3 3H8a3 3 0 0 1-3-3Z"/><path d="M5 12c2-1.5 12-1.5 14 0"/><path d="M12 12l5.5-8.5 1.7 1.1L14 13"/>` },
  ...
  { name: 'tattoo', category: 'services', keywords: ['tattoo', 'tattoo machine', 'ink', 'tattoo & piercing'],
    body: `<circle cx="15.5" cy="5.5" r="2"/><circle cx="15.5" cy="10.5" r="2"/><path d="M13.5 10.5H12"/><path d="M12.5 9l-7 7 2.5 2.5 7-7"/><path d="M5.5 16l-2.5 2.5"/><path d="M17.5 3.5V2M17.5 12.5V14"/>` },
  ...
  { name: 'walk-in', category: 'booking', keywords: ['walk in', 'door', 'enter', 'no appointment'],
    body: `<path d="M13 3h7v18h-7"/><path d="M16.5 12h.01"/><path d="M3 12h8M8.5 9l3 3-3 3"/>` },
  ...
  { name: 'qr-code', category: 'booking', keywords: ['qr', 'scan', 'referral code', 'pay link'],
    body: `<rect x="3" y="3" width="6" height="6" rx="1"/><rect x="15" y="3" width="6" height="6" rx="1"/><rect x="3" y="15" width="6" height="6" rx="1"/><path d="M6 6h.01M18 6h.01M6 18h.01"/><path d="M15 15h.01M18 15h3M15 18h.01M21 18h.01M15 21h3M21 21h.01"/>` },
  ...
  { name: 'tip', category: 'money', keywords: ['gratuity', 'hand', 'coin', 'give'],
    body: `<circle cx="15.5" cy="6.5" r="3.5"/><path d="M15.5 6.5h.01"/><path d="M3 14h3v7H3Z"/><path d="M6 15l5 1h4a1.5 1.5 0 0 1 0 3H9"/><path d="M15 17.5l4-1.5a1.5 1.5 0 0 1 1.5 2.5L13 21H6"/>` },
  ...
  { name: 'cash', category: 'money', keywords: ['banknote', 'bill', 'paper money', 'offline'],
    body: `<rect x="2" y="7" width="20" height="10" rx="1.5"/><circle cx="12" cy="12" r="2.5"/><path d="M5.5 12h.01M18.5 12h.01"/>` },
  ...
  { name: 'alert', category: 'money', keywords: ['dispute', 'warning', 'attention', 'issue'],
    body: `<path d="M12 3l10 17H2Z"/><path d="M12 10v4M12 17.5h.01"/>` },
  ...
  { name: 'extra-saver', category: 'programs', keywords: ['savings', 'piggy bank', 'saver', 'goal'],
    body: `<path d="M4 12c0-4 3.5-7 8-7 3 0 5.5 1.5 6.7 4H21v4h-1.6c-.4 1-1 1.8-1.7 2.5V19h-3v-1.5h-3.5V19H8v-3c-2.5-1-4-2.5-4-4Z"/><path d="M4 12H2.5c0 1 .5 1.5 1.5 1.5"/><path d="M15.5 11h.01"/><path d="M10.5 6h3"/>` },
