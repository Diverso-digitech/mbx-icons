...
export const icons = [
  ...
  { name: 'beard', category: 'services', keywords: ['beard trim', 'beard', 'shape', 'facial hair', 'beard & shave'],
    body: `<path d="M5 4.5c0 2.5-.5 5 0 7.5 1 5 3.5 8.5 7 8.5s6-3.5 7-8.5c.5-2.5 0-5 0-7.5"/><path d="M5 4.5c1 2.5 2 4 3.5 5 1 .7 2.2 1 3.5 1s2.5-.3 3.5-1c1.5-1 2.5-2.5 3.5-5"/><path d="M8.8 12c.8-1.6 2.1-1.9 3.2-.8 1.1-1.1 2.4-.8 3.2.8-1 .6-2.1.8-3.2.3-1.1.5-2.2.3-3.2-.3Z" fill="currentColor"/><path d="M9.8 14c.9 1 3.5 1 4.4 0"/><path d="M7.5 13l-.3 3M16.5 13l.3 3M12 16.5v2.5M9.7 15.2l-.2 2.6M14.3 15.2l.2 2.6"/>` },
  ...
  { name: 'pedicure', category: 'services', keywords: ['pedicure', 'foot', 'toes', 'toenails', 'foot care'],
    body: `<path d="M11 21c-3.5 0-5.5-2-5.5-5.5 0-2.5 1.3-4.5 1.7-7.5.3-2.3 3-3.3 5.3-2.3 2.7 1.2 5 2.3 5 5.3 0 4.5-2.5 10-6.5 10Z"/><circle cx="8.3" cy="4.6" r="1.9" fill="currentColor"/><circle cx="11.6" cy="3.4" r="1.25" fill="currentColor"/><circle cx="14.2" cy="4" r="1" fill="currentColor"/><circle cx="16.3" cy="5.5" r=".9" fill="currentColor"/><circle cx="17.8" cy="7.6" r=".8" fill="currentColor"/><path d="M20 12v3M18.5 13.5h3"/>` },
